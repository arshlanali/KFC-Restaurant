      ...
      <div className="flex items-center justify-between h-full">
        ...
        <div className="flex items-center gap-4 md:gap-7">
          <nav className="md:flex gap-4 md:gap-6 text-base md:text-lg hidden">
            <Link to={""}>Home</Link>
            <Link to={"menu/65bd4b514494566deb9bcaf4"}>Menu</Link>
          ...
          <div className="text-2xl text-slate-600 relative">
            ...
            <div className="absolute -top-1 -right-1 text-white bg-red-500 h-4 w-4 flex items-center justify-center rounded-full">
              <span class="text-xs font-semibold">{cartItemNumber.length}</span>
            </div>
            </Link>
          </div>
            ...
            {showMenu && (
              <div className="absolute right-2 bg-white py-2 px-2 shodow drop-shadow-md flex flex-col ">
                ...
                <nav className="flex flex-col text-base md:text-lg md:hidden">
                  ...
                  <Link to={"menu/65bd4b514494566deb9bcaf4"} className="px-2 py-1">Menu</Link>
